...
export default function AddItemPage() {
  ...
  const [marketplaceFormData, setMarketplaceFormData] = useState<FormData>({
    title: '',
    description: '',
    imageUrl: '',
    price: '',
  ...
  async function handleMarketplaceScrape() {
    ...
    try {
      ...
      // Auto-construct affiliate URL
      const affiliateUrl = constructAffiliateUrl(data.sourceUrl)
      ...
      // Store affiliate URL in scraped data for submission
      setMarketplaceScrapedData({ ...data, _affiliateUrl: affiliateUrl } as any)
    } catch (error) {
  ...
  async function handleMarketplaceSubmit() {
    ...
    try {
      ...
      showToast(`"${marketplaceFormData.title}" added to your registry!`, 'success')
          ...
          <div>
            ...
            <Card className="mb-6">
              <CardContent className="py-6">
                <label htmlFor="marketplace-search" className="block text-sm font-medium text-slate-700 mb-2">
