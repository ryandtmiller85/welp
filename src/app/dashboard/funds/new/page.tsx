...
export default function NewFundPage() {
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="border-2 border-green-200 bg-green-50">
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-slate-600 mb-6">Your fund is now live on your registry.</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-8 px-4">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Create a Fund</h1>
        <p className="text-slate-600 mb-8">Let people contribute cash toward something you need.</p>
